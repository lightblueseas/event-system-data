...
create table event_ratings (id int4 not null, rating_date timestamp, rating_description varchar(1024), rating_points int4, title_rating varchar(256), visibility varchar(255), contact int4, eventlocation int4, material int4, presentation int4, support int4, topic int4, rater int4, event_id int4, primary key (id));
